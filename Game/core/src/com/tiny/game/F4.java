...
/**
 * Created by alval on 25/05/2017.
 */
public class F4 {
    private int x,y;
    ...
    public F4(int x, int y){
        this.x=x;
        this.y=y;
        membrana  = new Texture(Gdx.files.internal("ParedMembrana/P4.jpg"));
        membrana1 = new Texture(Gdx.files.internal("ParedMembrana/R4.jpg"));
        membrana2 = new Texture(Gdx.files.internal("ParedMembrana/L4.jpg"));
        membrana3 = new Texture(Gdx.files.internal("ParedMembrana/S4.jpg"));
    }
