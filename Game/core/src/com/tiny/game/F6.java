...
public class F6{
    ...
    public F6(int x, int y){
        this.x=x;
        this.y=y;
        membrana  = new Texture(Gdx.files.internal("ParedMembrana/P6.jpg"));
        membrana1 = new Texture(Gdx.files.internal("ParedMembrana/R6.jpg"));
        membrana2 = new Texture(Gdx.files.internal("ParedMembrana/L6.jpg"));
        membrana3 = new Texture(Gdx.files.internal("ParedMembrana/S6.jpg"));
    }
