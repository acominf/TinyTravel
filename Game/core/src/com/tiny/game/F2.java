...
public class F2 {
    ...
    public F2(int x, int y){
        this.x=x;
        this.y=y;
        membrana  = new Texture(Gdx.files.internal("ParedMembrana/P2.jpg"));
        membrana1 = new Texture(Gdx.files.internal("ParedMembrana/R2.jpg"));
        membrana2 = new Texture(Gdx.files.internal("ParedMembrana/L2.jpg"));
        membrana3 = new Texture(Gdx.files.internal("ParedMembrana/S2.jpg"));
    }
