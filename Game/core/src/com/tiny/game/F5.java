...
public class F5 {
    ...
    public F5(int x, int y){
        this.x=x;
        this.y=y;
        membrana  = new Texture(Gdx.files.internal("ParedMembrana/P5.jpg"));
        membrana1 = new Texture(Gdx.files.internal("ParedMembrana/R5.jpg"));
        membrana2 = new Texture(Gdx.files.internal("ParedMembrana/L5.jpg"));
        membrana3 = new Texture(Gdx.files.internal("ParedMembrana/S5.jpg"));
    }
